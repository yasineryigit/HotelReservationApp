...
import com.ossovita.accountingservice.business.abstracts.feign.HotelClient;
...
public class ReservationPaymentManager implements ReservationPaymentService {
    ...
    public ReservationPaymentManager(ReservationClient reservationClient, HotelClient hotelClient, ReservationPaymentRepository reservationPaymentRepository, ModelMapper modelMapper, KafkaTemplate<String, Object> kafkaTemplate) {
